        ...
        <View className="bg-white rounded-t-3xl px-7 pt-6 pb-10">
          {step === 'payment' ? (
            <>
              ...
              <Text className="text-2xl font-extrabold text-gray-800 text-center mb-5">Finalizar Pedido</Text>
              <Text className="text-sm font-semibold text-gray-500 mb-4">Forma de Pagamento</Text>
              ...
              <View className="flex-row justify-between items-center mb-6">
                ...
                <Text className="text-xl font-extrabold text-brand-dark">R$ {total.toFixed(2)}</Text>
              </View>
            ...
            <>
              <View className="self-center w-10 h-1 rounded-full bg-gray-200 mb-5" />
              <Text className="text-2xl font-extrabold text-gray-800 text-center mb-5">🎉 Pedido Confirmado!</Text>

              <View className="bg-brand-light rounded-2xl p-5 mb-6">
                <View className="flex-row items-center mb-3">
                  <Ionicons name="bicycle" size={22} color="#5BB5D5" />
                  <Text className="text-base font-bold text-gray-700 ml-2">Entregador a caminho!</Text>
                </View>
