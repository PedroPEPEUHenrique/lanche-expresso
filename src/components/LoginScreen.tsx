    ...
    <KeyboardAvoidingView className="flex-1 bg-white" behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
        <View className="flex-1 px-8 pt-20 pb-10">
          ...
          <Text className="text-lg text-gray-500 text-center mb-8 font-medium">Acesse sua conta</Text>

          <View className="w-full gap-y-4">
            <View>
              <Text className="text-sm font-semibold text-gray-600 mb-1.5">E-mail</Text>
              <View className={`flex-row items-center h-12 border-[1.5px] rounded-xl px-3 bg-sky-50 ${emailFocused ? 'border-brand' : 'border-gray-200'}`}>
            ...
            <View>
              ...
              <View className={`flex-row items-center h-12 border-[1.5px] rounded-xl px-3 bg-sky-50 ${passFocused ? 'border-brand' : 'border-gray-200'}`}>
